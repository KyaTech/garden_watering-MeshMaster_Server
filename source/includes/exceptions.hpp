...
public:
    explicit ResponseNotFoundException(unsigned long request_id) : _request_id(request_id) {};
...
public:
    PayloadNotSendableException(string message, unsigned long request_id) : _message(std::move(message)),
                                                                            _request_id(request_id) {};

    explicit PayloadNotSendableException(string message) : _message(std::move(message)) {};
